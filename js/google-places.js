    ...
    $.googlePlaces = function(element, options) {
        ...
        var renderReviews = function(reviews){
          ...
          for (var i = row_count; i >= 0; i--) {
           ...
           //added by Nitzan
            if (i==2) {
                html = html+"<div style='display:block;' class= 'review-item'><div class='review-meta'><span class='review-author'>"+name+"<span class='review-date'>"+"</span></div>"+stars+"<p class='review-text'>"+reviews[i].text+"</p></div>"
            }
            else {
                html = html+"<div style='display:none;' class='review-item'><div class='review-meta'><span class='review-author'>"+name+"<span class='review-date'>"+"</span></div>"+stars+"<p class='review-text'>"+reviews[i].text+"</p></div>"
            }
